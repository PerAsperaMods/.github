...
**User Wiki**:
- **Building Tutorial** : `F:\ModPeraspera\Organization-Wiki\tutorials\Buildings.md`
- **YAML Datamodel** : `F:\ModPeraspera\Organization-Wiki\content\YAML-Datamodel.md` (TODO)
