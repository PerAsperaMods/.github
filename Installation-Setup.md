...
🎯 **Complete guide to setting up the PerAspera SDK development environment for international developers.**

## 🌍 Language Support

This guide is available in multiple languages:
- **English** (this page)
- **Français** ([Installation-Configuration](Installation-Configuration-FR))
- **Deutsch** ([Installation-Einrichtung](Installation-Einrichtung-DE))
- **Español** ([Instalación-Configuración](Instalacion-Configuracion-ES))
- **日本語** ([インストール-セットアップ](Installation-Setup-JP))
...
1. Check the [Troubleshooting Guide](Debugging-Guide)
...
1. **[Create Your First Mod](First-Mod-Tutorial)** - Build a simple climate monitoring mod
2. **[Explore Examples](Code-Examples)** - See practical code samples
3. **[Read API Reference](SDK-API-Reference)** - Understand available features
4. **[Join Community](https://discord.gg/peraspera-modding)** - Connect with other modders

Ready to start modding? Let's terraform Mars with code! 🚀

---

## 🌍 Community Translations

Help us translate this guide:
- **Missing a language?** [Contribute a translation](Translation-Project)
- **Found an error?** [Report it on GitHub](https://github.com/PerAsperaMods/PerAspera-SDK/issues)
- **Want to help?** [Join our translation team](https://discord.gg/peraspera-modding)